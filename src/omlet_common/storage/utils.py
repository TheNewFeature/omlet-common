...
https://github.com/minio/minio-py/blob/c6c43abc1b7412443d8dd974501a282c6e041e76/examples/progress.py
"""
...
class Progress(Thread):
    ...
    def done_progress(self):
        self.done = True
        self.stdout.write(_NEWLINE_CHAR)
    ...
    def print_status(self, current_size, total_length, displayed_time, prefix):
        ...
        self.stdout.write(_REFRESH_CHAR + TextColor.BOLD + formatted_str + ' ' *
                          max(self.last_printed_len - len(formatted_str), 0) + TextColor.ENDC)
        self.stdout.flush()
